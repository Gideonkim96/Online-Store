...
import static online.store.model.CheckoutRequest.isNullOrBlank;
...
public class CheckoutController {
    ...
    public ResponseEntity<String> handleCreditCardError(Exception exception){
        System.out.println(String.format("Request to /checkout path threw an exception %s",exception.getMessage()));
